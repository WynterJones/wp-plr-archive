...
$.fn.flip = function(settings){
    return this.each( function() {
		...
		var revertedSettings = {
			...
			bgColor: acceptHexColor(settings.color) || "#3a3a3a",
        ...
        flipObj = {
            ...
            toColor: acceptHexColor(settings.color) || "#3a3a3a",
            speed: settings.speed || 500,
			easing:"easeOutCirc", 
            top: $this.offset().top,
        ...
        $clone= $this.css("visibility","hidden")
            ...
            .appendTo("body")
            .html("")
            .css({visibility:"visible",position:"absolute",opacity:1,left:flipObj.left,top:flipObj.top,margin:0,zIndex:9999,"-webkit-box-shadow":"0px 0px 0px #3a3a3a","-moz-box-shadow":"0px 0px 0px #3a3a3a"});
        ...
        var defaultHorizontal=function() {
            ...
            return {
                ...
                "first": {
                    ...
                    top: (flipObj.top+(flipObj.height)),
        ...
        dirOptions = {
            "tb": function () {
                ...
                d.second.borderBottomColor= '#3a3a3a';
                return d;
            },
            "bt": function () {
                var d=defaultHorizontal();
