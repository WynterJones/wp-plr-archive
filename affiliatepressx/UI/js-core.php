...
$('#affiliatepressx_popupID').change(function() {
  $('#changePopup').submit();
});
	...
	$('#saveIt').click(function() {
		...
		$("#updatedMessage").fadeIn(1000).delay(500).fadeOut(1000);
