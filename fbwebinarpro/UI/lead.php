...
<div id="editdep">
	...
	<a href="<?php echo site_url(); ?>/wp-content/plugins/fbwebinarpro/inc/csv.php?id=<?php echo $_GET['lead']; ?>" class="uibutton large special" target="_blank" style="margin-top: 15px;" >Export To CSV</a>
