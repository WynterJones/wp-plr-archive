...
jQuery(document).ready(function($) {
	...
	$('#views').html($.number($('#views').text()));
	$('#shares').html($.number($('#shares').text()));
	$('#leads').html($.number($('#leads').text()));
	$('#clicks').html($.number($('#clicks').text()));
	$('#ctr').html($.number($('#ctr').text())+'%');
	$('#agree').html($.number($('#agree').text()));
	$('#disagree').html($.number($('#disagree').text()));

	$('#question').inputlimiter({
		limit: 65,
		remText: 'You only have %n character%s remaining...',
		remFullText: 'Stop typing! You\'re not allowed any more characters!',
		limitText: 'You\'re allowed to input %n character%s into this field.'
	});
	$('#yesText').inputlimiter({
		limit: 10,
		remText: 'You only have %n character%s remaining...',
		remFullText: 'Stop typing! You\'re not allowed any more characters!',
		limitText: 'You\'re allowed to input %n character%s into this field.'
	...
	$('#emailButton').inputlimiter({
		limit: 40,
		remText: 'You only have %n character%s remaining...',
		remFullText: 'Stop typing! You\'re not allowed any more characters!',
		limitText: 'You\'re allowed to input %n character%s into this field.'
	});
	$('#linkButton').inputlimiter({
		limit: 40,
		remText: 'You only have %n character%s remaining...',
		remFullText: 'Stop typing! You\'re not allowed any more characters!',
		limitText: 'You\'re allowed to input %n character%s into this field.'
	});
	$('#emailHeadline').inputlimiter({
		limit: 60,
		remText: 'You only have %n character%s remaining...',
		remFullText: 'Stop typing! You\'re not allowed any more characters!',
		limitText: 'You\'re allowed to input %n character%s into this field.'
	});
	$('#linkSubHeadline').inputlimiter({
		limit: 40,
		remText: 'You only have %n character%s remaining...',
		remFullText: 'Stop typing! You\'re not allowed any more characters!',
		limitText: 'You\'re allowed to input %n character%s into this field.'
	});
	$('#linkHeadline').inputlimiter({
		limit: 40,
		remText: 'You only have %n character%s remaining...',
		remFullText: 'Stop typing! You\'re not allowed any more characters!',
		limitText: 'You\'re allowed to input %n character%s into this field.'
	});
	$('#linkSmallHeadline').inputlimiter({
		limit: 60,
		remText: 'You only have %n character%s remaining...',
		remFullText: 'Stop typing! You\'re not allowed any more characters!',
		limitText: 'You\'re allowed to input %n character%s into this field.'
	...
	$('#answerYesNoHeadline, #answerYesYesHeadline, #answerNoNoHeadline, #answerNoYesHeadline, #answerYesHeadline, #answerNoHeadline').inputlimiter({
		limit: 28,
		remText: 'You only have %n character%s remaining...',
		remFullText: 'Stop typing! You\'re not allowed any more characters!',
		limitText: 'You\'re allowed to input %n character%s into this field.'
	});
	$('#answerYesNoSubHeadline, #answerYesYesSubHeadline, #answerNoNoSubHeadline, #answerNoYesSubHeadline, #answerYesSubHeadline, #answerNoSubHeadline').inputlimiter({
		limit: 50,
		remText: 'You only have %n character%s remaining...',
		remFullText: 'Stop typing! You\'re not allowed any more characters!',
		limitText: 'You\'re allowed to input %n character%s into this field.'
	...
	$('#answerYesNoText, #answerYesYesText, #answerNoNoText, #answerNoYesText, #answerYesText, #answerNoText').inputlimiter({
		limit: 58,
		remText: 'You only have %n character%s remaining...',
		remFullText: 'Stop typing! You\'re not allowed any more characters!',
		limitText: 'You\'re allowed to input %n character%s into this field.'
	...
	if($('#questionFollowup').val() == "show") {
		$('#followUp').slideDown();
	}
	else {
		$('#followUp').slideUp();
	}
	$('#questionFollowup').change(function() {
	if($(this).val() == "show") {
		$('#followUp').slideDown();
	}
	else {
	...
	$('#createnewapp').one( "click", function() {
