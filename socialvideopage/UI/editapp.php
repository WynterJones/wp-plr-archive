...
<div class="editTop">
		<div class="appinfo">
	<a href="http://codecore.io" target="_blank" style="width: 40px; float: right;text-align: center;text-decoration: none;color: #ccc; margin-right: -25px;margin-top: 5px; margin-bottom: -10px"><img src="../wp-content/plugins/socialoptinx/images/codecore.png" style="width: 100%"><strong>v1.1</strong></a>
