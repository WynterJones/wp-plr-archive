...
<style type="text/css">
	...
	.tabber h2.headline {
		padding-left: 20px;padding-top: 40px; color: #5b6d7b; font-weight: bold;
	}
	...
	.editArea{
		...
		background-image: -webkit-gradient(linear, center top, center bottom, from(#fafafa), to(#fff));
...
color: #fff;
	...
	.editTop {
		background: #CD4E38;
		background-image: -webkit-gradient(linear, center top, center bottom, from(#EC6151), to(#BA382B));
		background-image: -webkit-linear-gradient(top, #EC6151, #BA382B);
		background-image: -moz-linear-gradient(top, #EC6151, #BA382B);
		background-image: -o-linear-gradient(top, #EC6151, #BA382B);
		background-image: -ms-linear-gradient(top, #EC6151, #BA382B);
		background-image: linear-gradient(to bottom, #EC6151, #BA382B);
		color: #fff;
		text-shadow: 1px 1px 1px #832A21;
		border-bottom: 0;
	}
	.editNav {
		background-color: #fdfdfd;
		background-image: -webkit-gradient(linear, center top, center bottom, from(#333), to(#111));
	...
	.titleBar {
		background-color: #fdfdfd;
		background-image: -webkit-gradient(linear, center top, center bottom, from(#000), to(#222));
