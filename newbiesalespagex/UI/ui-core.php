...
function display_field($num, $data, $title, $id, $help){
	...
	<div class="editSection">
		...
		<div class="inputTitle">
			<span style="font-size: 15px; font-weight: bold; color: #444"><?php echo $title; ?></span>
			<span style="display: block; font-size: 11px; font-weight: normal; padding: 10px 0; padding-right: 60px;"><?php echo $help; ?></span>
		</div>

		<div class="inputSection">
			<input class="inputField elem" type="text" name="<?php echo $id; ?>" id="<?php echo $id; ?>" value="<?php echo htmlspecialchars(stripcslashes($data)); ?>">
		</div>
		<br clear="left" >
...
function display_field_image($num, $data, $title, $id, $help){
	...
	<div class="editSection">
		...
		<div class="inputSection">
			<input style="float:left; width: 420px; " class="inputField elem" type="text" name="<?php echo $id; ?>" id="<?php echo $id; ?>" value="<?php echo htmlspecialchars(stripcslashes($data)); ?>">
...
function display_textarea($num, $data, $title, $id, $help){
	...
	<div class="editSection">
		...
		<div class="inputSection">
			<textarea name="<?php echo $id; ?>" id="<?php echo $id; ?>" class="inputTextarea elem" ><?php echo htmlspecialchars(stripcslashes($data)); ?></textarea>
		</div>
		<br clear="left" >
