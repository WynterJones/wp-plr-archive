      ...
      init: function(opts) {
        ...
        groups = [
          [
            {
              name: 'bold',
              label: "<span style='font-weight:bold;'><img src='https://cdn1.iconfinder.com/data/icons/gnomeicontheme/24x24/actions/format-text-bold.png' /></span>",
              title: 'Bold (Ctrl+B)',
              classname: 'toolbar_bold'
            }, {
              name: 'italic',
              label: "<span style='font-style:italic;'><img src='https://cdn2.iconfinder.com/data/icons/gnomeicontheme/24x24/actions/format-text-italic.png' /></span>",
              title: 'Italic (Ctrl+I)',
              classname: 'toolbar_italic'
            }, {
              name: 'underline',
              label: "<span style='text-decoration:underline!important;'><img src='https://cdn2.iconfinder.com/data/icons/gnomeicontheme/24x24/actions/format-text-underline.png' /></span>",
            ...
            {
              name: 'justifyleft',
              label: "<div  style='margin-top:2px; margin-left: -3px;'><img src='https://cdn2.iconfinder.com/data/icons/gnomeicontheme/24x24/actions/format-justify-left.png' /></div>",
              title: 'Left justify',
              classname: 'toolbar_justifyleft'
            }, {
              name: 'justifycenter',
              label: "<div  style='margin-top:2px;'><img src='https://cdn2.iconfinder.com/data/icons/gnomeicontheme/24x24/actions/stock_text_center.png' /></div>",
              title: 'Center justify',
              classname: 'toolbar_justifycenter'
            }, {
              name: 'justifyright',
              label: "<div  style='margin-top:2px;'><img src='https://cdn2.iconfinder.com/data/icons/gnomeicontheme/24x24/actions/format-justify-right.png' /></div>",
              title: 'Right justify',
              classname: 'toolbar_justifyright'
            }, {
              name: 'justifyfull',
              label: "<div  style='margin-top:2px;'><img src='https://cdn2.iconfinder.com/data/icons/gnomeicontheme/24x24/actions/stock_text_justify.png' /></div>",
              title: 'Full justify',
            ...
            {
              name: 'createlink',
              label: "<div  style='margin-top:2px;'><img src='https://cdn2.iconfinder.com/data/icons/crystalproject/Open-Office-Icons/stock_link.png' /></div>",
              title: 'Link to a web page (Ctrl+L)',
              userinput: "yes",
              classname: 'toolbar_link'
            }, {
              name: 'insertimage',
              label: "<div  style='margin-top:2px;'><img src='https://cdn2.iconfinder.com/data/icons/gnomeicontheme/24x24/actions/insert-image.png' /></div>",
              title: 'Insert an image (Ctrl+G)',
              userinput: "yes",
              classname: 'toolbar_image'
            }, {
              name: 'insertorderedlist',
              label: "<div  style='margin-top:2px;'><img src='https://cdn2.iconfinder.com/data/icons/gnomeicontheme/24x24/stock/text/stock_list_enum.png' /></div>",
              title: 'Insert ordered list',
              classname: 'toolbar_ol'
            }, {
              name: 'insertunorderedlist',
              label: "<div  style='margin-top:2px;'><img src='https://cdn2.iconfinder.com/data/icons/gnomeicontheme/24x24/stock/text/stock_list_bullet.png' /></div>",
          ...
          ], [
            {
              ...
              label: "<div  style='margin-top:2px;'><strong>P</strong></div>",
              title: 'Insert a paragraph (Ctrl+Alt+0)',
              classname: 'toolbar_p',
              block: 'p'
            }, {
              name: 'insertheading1',
              label: "<div  style='margin-top:2px;'><strong>H1</strong></div>",
              title: "Heading 1 (Ctrl+Alt+1)",
              classname: 'toolbar_h1',
              block: 'h1'
            }, {
              name: 'insertheading2',
              label: "<div  style='margin-top:2px;'><strong>H2</strong></div>",
              title: "Heading 2 (Ctrl+Alt+2)",
              classname: 'toolbar_h2',
              block: 'h2'
            }, {
              name: 'insertheading3',
              label: "<div  style='margin-top:2px;'><strong>H3</strong></div>",
              title: "Heading 3 (Ctrl+Alt+3)",
              classname: 'toolbar_h3',
              block: 'h3'
            }, {
              name: 'insertheading4',
              label: "<div  style='margin-top:2px;'><strong>H4</strong></div>",
