<?php
	...
	$assets = $full_path . "/wp-content/plugins/wpsocialboost/socialCorner/";
...
<div id="content" style="text-align: center;border: 3px solid #ccc; background: #fff; height: 150px">
  <h3 style="padding: 0 20px; letter-spacing: -1px; padding-top: 14px"><strong><?php displayInput('scrollHeadline', 'Do You Like This Story? Share it on Facebook'); ?></strong></h3>
  <iframe src="http://www.facebook.com/plugins/like.php?href=<?php displayInput('facebookURL', ''); ?>&amp;width&amp;layout=button_count&amp;action=like&amp;show_faces=true&amp;share=true&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; height:21px;width: 130px; margin: 0 auto" allowTransparency="true"></iframe>
        <br>  <br>
</div>
