...
#cd_mainContent{
	background: url(<?php echo site_url(); ?>/wp-content/plugins/fbsurveypro/images/repeater.png) repeat-y;
	padding: 20px;
	padding-left: 40px;
	padding-right: 40px;
}
...
#cd_headerWrapper{
	...
	height: 190px;
	margin-top: 20px;
	background: url(<?php echo site_url(); ?>/wp-content/plugins/fbsurveypro/images/header.png) no-repeat;
}
