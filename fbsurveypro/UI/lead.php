...
<div id="editdep">
	...
	<?php 
		...
		$table_db_name = $wpdb->prefix . "fbsurveypro_users";
	...
	<a href="<?php echo site_url(); ?>/wp-content/plugins/fbsurveypro/inc/csv.php?id=<?php echo $_GET['lead']; ?>" class="uibutton large special" target="_blank" style="margin-top: 15px;" >Export To CSV</a>
