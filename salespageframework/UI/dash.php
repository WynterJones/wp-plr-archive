...
<div id="listapps">
	...
	<div id="appHeader">
		<span>Manage All Your Sales Pages:</span>
	</div>
	...
	<div class="appnew">
		...
		<div class="blue-btn btn" style="width: 100px; text-align: center" ><a href="<?php echo site_url(); ?>/wp-admin?page=salespageframework-dashboard&create">Create New</a></div>	
