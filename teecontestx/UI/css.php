...
color: #fff;
	...
	/* Main Header */
	#appHeader {
		background: url(../wp-content/plugins/teecontestx/images/grey_wash_wall.png) repeat;
	text-shadow: 0 1px 0 #181526;
		color: #fff;
	...
	.editNav {
		background: url(../wp-content/plugins/teecontestx/images/dirty_old_shirt.png) repeat;
...
transition: background-color 0.5s ease;
	...
	.titleBar {
		background: url(../wp-content/plugins/teecontestx/images/ps_neutral.png) repeat;
	}
		.titleBar h2 {
			font-size: 28px;
			letter-spacing: -1px;
