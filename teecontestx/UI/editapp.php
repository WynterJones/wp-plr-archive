...
<div class="editTop">
	...
	<div style="float: right; margin-top: 15px; margin-right: -60px">
		<?php 
			if (get_option($_GET['id'].'_tc_views') != '') {
				$views = get_option($_GET['id'].'_tc_views');	
			}
			else {
				$views = 0;
			}
			if (get_option('tc_clicks'.'_'.$_GET['id']) != '') {
				$clicks = get_option('tc_clicks'.'_'.$_GET['id']) ;
			}
			else {
				$clicks = 0;
			}
...
<div class="editNav">
		...
		<div class="editItem2" style="float:right;">
			<span class="grey-btn btn saveIt" style="margin-left:-10px;" ><a href="#" id="saveIt_text">Update Page</a></span>
		</div>
		<br clear="all" >
</div>
<div class="editArea">
	...
	<div style="border-top: 1px dotted #e2e2e2; padding-top: 15px; margin-top: 25px; ">
		<span class="grey-btn btn saveIt" style="float: right;" ><a href="#" id="saveIt_text">Update Page</a></span>
