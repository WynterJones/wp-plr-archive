	...
	$("#jquery_jplayer_1").jPlayer({
		...
		ready: function () {
			...
			$(this).jPlayer("setMedia", {
				m4v: "<?php echo $template['video']; ?>",
				poster: "<?php echo $template['video_poster']; ?>"
...
$('.jp-current-time-input').val($('.jp-current-time').html());

setInterval(function(){
       $('.jp-current-time-input').val($('.jp-current-time').html());
       if ($('.jp-current-time-input').val() == "<?php echo $template['alertTime']; ?>") {
			$('#alert').fadeIn();
		};

		if ($('.jp-current-time-input').val() == "<?php echo $template['slider']; ?>") {
			$('.extra').fadeIn();
		};

		if ($('.jp-current-time-input').val() == "<?php echo $template['ar_time']; ?>") {
			$('#optin').fadeIn();
		};

		if ($('.jp-current-time-input').val() == "<?php echo $template['flash']; ?>") {
...
if ("<?php echo $template['slider']; ?>" == '') {
				...
				$('.twitter').click(function() {
					var url = "<?php echo $template['twitter']; ?>";    
					window.open(
					  url,
					  '_blank'
					);
				...
				$('.ctaButton').click(function() {
					var url = "<?php echo get_bloginfo('buttonURL'); ?>";    
					window.open(
					  url,
					  '_blank'
					);
...
img#jp_poster_0 {
	-webkit-box-reflect: below 4px -webkit-gradient(linear, left top, left bottom, from(transparent), color-stop(.86, transparent), to(white));
...
<body>
		...
		<div id="optin" style="display: none">
			...
			<?php if ($template['design'] == '') { ?>
				<div id="overlay2" style="position: absolute; width: 100%;  border-radius: 5px; border: 1px solid #000; z-index: 9999; background: #222; opacity: .8; display: block; text-align: center;"></div>
			<?php } ?>
			<div id="pop2" style="display: block; position: absolute; margin-left: 4%; border-radius: 5px;border: 1px solid #ccc;box-shadow: 0 2px 2px #777; top: 6%; z-index: 99999; background:#fff; padding: 20px; width: 85%;">
				<form action="" class='ARform'>
...
<?php if ($template['design'] == 'black') { ?>
			...
			<div class="jp-gui ui-widget ui-widget-content ui-corner-all">
				...
				<a href="<?php echo get_bloginfo('siteurl'); ?>" class="siteurl" target="_blank"><img src="<?php echo $template['logo']; ?>" style="float: left; position: relative;z-index:99999;width: 25%; padding:  4px"></a>
					<div id="player">
						<div class="jp-progress-slider" style="position: relative;z-index:99999;"></div>
					<div class="jp-current-time" style="position: relative;z-index:99999;"></div>
					<input type="hidden" class="jp-current-time-input">
					<div class="jp-duration" style="position: relative;z-index:99999;"></div>
					<div class="jp-volume-slider" style="position: relative;z-index:99999;"></div>
					<ul style="width: 75%; position: relative;z-index:99999;margin-right: -2%; margin-top: -20px;">
						...
						<li><a href="javascript:;" class="jp-repeat" tabindex="1" title="repeat"><img src="http://cdn2.iconfinder.com/data/icons/ledicons/control_repeat.png" style="opacity: .3;margin-bottom: -2px"></a></li>
								<li><a href="javascript:;" class="jp-repeat-off" tabindex="1" title="repeat off"><img src="http://cdn2.iconfinder.com/data/icons/ledicons/control_repeat.png" style="margin-bottom: -2px"></a></li>
						<li class=" " style=" float: right;"><a href="<?php echo get_bloginfo('siteurl'); ?>" target="_blank" class="siteurl" tabindex="1"  ><img src="http://cdn2.iconfinder.com/data/icons/tango/16x16/apps/internet-web-browser.png" style="margin-bottom: -2px;"></a></a></li>
						<?php if ($template['twitter']) { ?>
							<li class=" " style=" float: right;"><a href="<?php echo $template['twitter']; ?>" target="_blank" class="ui-icon-none twitter" tabindex="1"  ><img src="http://cdn3.iconfinder.com/data/icons/socialmediabookmark/16/twitter.png" style="margin-bottom: -2px"></a></li>
						<?php } ?>
						<?php if ($template['fb']) { ?>
							<li class=" " style=" float: right;"><a href="<?php echo $template['fb']; ?>" target="_blank" class="facebook" tabindex="1"><img src="http://cdn3.iconfinder.com/data/icons/socialmediabookmark/16/facebook.png" style="margin-bottom: -2px"></a></a></li>
						<?php } ?>
					</ul>
