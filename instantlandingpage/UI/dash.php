...
<div id="listapps">
	...
	<div class="appnew">
		...
		<div class="blue-btn btn" style="width: 100px; text-align: center" ><a href="<?php echo site_url(); ?>/wp-admin?page=instantlandingpage-dashboard&create">Create New</a></div>	
