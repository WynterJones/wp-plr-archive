<?php
function lpdesignerx_dashboard(){
// Universal Variables
...
<div id="mWrapper">
	<div id="container">
		<img src="<?php echo $sitePath; ?>/images/logo.png" style="margin: 0 auto; display: block;" alt=""><br>
	<?php 
				// Edit App
				if ( isset($_GET['id']) ) {
					include("editapp.php");
	...
	<div style="padding: 0 30px; margin-top: -10px">
		<p>Landing Page Designer v1.1 <strong style="float: right;">Copyright &copy; 2014</strong></p>
	</div>
</div>		
<?php
}
